    ...
    m_xHigh(0.f)
{
    ...
    PandoraThrowOnError(XmlHelper::ReadValue(xmlHandle, "NBinsX", m_nBinsX));
    PandoraThrowOnError(XmlHelper::ReadValue(xmlHandle, "XLow", m_xLow));
    PandoraThrowOnError(XmlHelper::ReadValue(xmlHandle, "XHigh", m_xHigh));
    ...
    PandoraThrowOnError(XmlHelper::ReadVectorOfValues(xmlHandle, "BinContents", orderedBinContents));
    ...
    m_yHigh(0.f)
{
    ...
    PandoraThrowOnError(XmlHelper::ReadValue(xmlHandle, "NBinsY", m_nBinsY));
    PandoraThrowOnError(XmlHelper::ReadValue(xmlHandle, "YLow", m_yLow));
    PandoraThrowOnError(XmlHelper::ReadValue(xmlHandle, "YHigh", m_yHigh));
    ...
    PandoraThrowOnError(XmlHelper::Read2DVectorOfValues(xmlHandle, "BinContents", "Row", histogramEntryList));
